...
class Spider(BaseSpider):  # 元类 默认的元类 type
    ...
    def searchContent(self, key, quick=False, pg=1):
        url = f'https://www.novipnoad.us/?s={key}'
        r = self.fetch(url, headers=self.headers)
        ret = r.text
        pdfa = self.jsp.pdfa
        pdfh = self.jsp.pdfh
...
if __name__ == '__main__':
    ...
    print(spider.detailContent(['https://www.novipnoad.us/movie/147890.html']))
    # print(spider.detailContent(['https://www.novipnoad.us/tv/hongkong/137568.html']))
    print(spider.playerContent('精彩线路', 'https://www.novipnoad.us/movie/147890.html', None))
